...
public class GazeHandlerFactory {
    ...
    public static IGazeHandler createHandler(Object target,
        ...
        if (target instanceof StyledText &&
        	...
        	System.out.println("whaa!!!"+ partRef.getPartName().toString());
        	//include the name of the editorReference to navigate between feature and java files
            return new StyledTextGazeHandler(target, partRef.getPartName().toString()); //can go back to using partRef
